  ...
  return (
    <Collapsible.Root className="group" defaultOpen={moduleIndex === 0}>
      <Collapsible.Trigger className="flex w-full items-center gap-3  bg-sky-800 p-4 ">
        <span className="flex h-10 w-10 items-center justify-center rounded-full border-zinc-300 bg-sky-950 text-xs transition-transform group-data-[state=open]:border">
          {moduleIndex + 1}
        </span>
